...
echo '<td class="benf"><a href="sub_sum_by_benf_month.php?nps_id='.$nps_id.'&benf_date='.$benf_date.'&project='.$project.'&dc_id='.$dc_id.'&block='.$block.'&month='.$month.'&year='.$year.'">'.$total.' </a></td>';
