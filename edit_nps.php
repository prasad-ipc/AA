...
<head>
	...
	<title>HostGod : Edit NPS Details</title>
	...
	<script type="text/javascript">
		$(function(){
			$('#dg').edatagrid({
				url: 'get_nps.php',
				saveUrl: 'save_nps.php',
				updateUrl: 'update_nps.php',
				destroyUrl: 'destroy_nps.php'
...
<body>
	<h2>Edit NPS Details</h2>
	<div class="demo-info" style="margin-bottom:10px">
		<div class="demo-tip icon-tip">&nbsp;</div>
		<div>Double click the row to begin editing.</div>
	</div>
	
	<table id="dg" title="NPS" style="width:100%;height:auto"
		...
		<thead>
			<tr>
				...
				<th field="mandal" width="50" editor="{type:'validatebox',options:{required:true}}">mandal</th>
				<th field="nps_name" width="50" editor="{type:'validatebox',options:{required:true}}">nps_name</th>
				...
				<th field="emp_block" width="50" editor="{type:'validatebox',options:{required:false}}">emp_block</th>
