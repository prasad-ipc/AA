...
if($blk<>$block){
echo '<td class="benf"><a href="sub_sum_by_nps_date.php?benf_date='.$benf_date.'&project='.$project.'&dc_id='.$dc_id.'&block='.$block.'&day='.$day.'&month='.$month.'&year='.$year.'">'.$block.' </a></td>';
$blk=$block;
}else{
    echo '<td class="benf"></td>';
}   
...
echo '<tr>';
echo '<td class="benf" colspan="5">G/TOTAL</td>';
