...
$sql = "insert into benf(benf_date, project_id, nps_id, benf_name,
 benf_fath_name, benf_contact_no, benf_vill, benf_mandal, benf_dist, 
 benf_pin,benf_remarks) 
 values
 ('$benf_date', '$project_id', '$nps_id', 
 '$benf_name', '$benf_fath_name', '$benf_contact_no', '$benf_vill',  
