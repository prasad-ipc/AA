...
echo '<div class="heading">SUMMARY BY DC '.$month1.'</div>';
...
if($dist<>$district){
echo '<td class="benf"><a href="sub_sum_by_bc_month.php?benf_date='.$benf_date.'&project='.$project.'&dc_id='.$dc_id.'&block='.$block.'&month='.$month.'&year='.$year.'">'.$district.' </a></td>';
$dist=$district;
}else{
    echo '<td class="benf"></td>';
}
