...
echo '<td class="benf"><a href="sub_sum_by_benf_with_date.php?nps_id='.$nps_id.'&benf_date='.$benf_date.'&project='.$project.'&dc_id='.$dc_id.'&block='.$block.'&day='.$day.'&month='.$month.'&year='.$year.'">'.$total.' </a></td>';
