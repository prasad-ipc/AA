...
$sql = "insert into areaco(nps_id,bc_id,mandal,contact_no,emp_vill,emp_po,emp_block,emp_dist,emp_id,emp_doj) 
 values
 ('$nps_id','$bc_id','$mandal','$contact_no','$emp_vill','$emp_po','$emp_block','$emp_dist','$emp_id','$emp_doj')";
@mysql_query($sql);
